...
object Messages {
  ...
  //val dateFormat = new ISO8601DateFormat()
  ...
  def parseWatch(objectNode: ObjectNode): Watch = {
    ...
    Watch(maybeEnable, maybeJson, maybeNmea, maybeRaw, maybeScaled, maybeDevice, maybeRemote, maybeTiming)
  }
